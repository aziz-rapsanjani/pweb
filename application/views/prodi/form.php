			...
			<div class="card-body">
				<form action="<?php echo $action; ?>" method="post" novalidate>
					...
					<div class="mb-3">
						...
						<input type="text" name="prodi_id" id="prodi_id" class="form-control <?php echo form_error('prodi_id') ? 'is-invalid' : (isset($_POST['prodi_id']) ? 'is-valid' : ''); ?>" value="<?php echo set_value('prodi_id', isset($prodi['prodi_id']) ? $prodi['prodi_id'] : ''); ?>" placeholder="Masukkan ID Program Studi" <?php echo isset($button) && $button === 'Update' ? 'readonly' : ''; ?>>
						...
						<div>
							...
							foreach ($strata_options as $s): ?>
								<div class="form-check form-check-inline">
									<input style="cursor: pointer;" class="form-check-input <?php echo form_error('prodi_strata') ? 'is-invalid' : (isset($_POST['prodi_strata']) ? 'is-valid' : ''); ?>"
